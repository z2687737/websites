...
//( 1 ) inserting Login Data: Route to insert new login data
router.post('/', (req, res) => {
...
/* (ITEM 2) after login sucessfully, data saved on database, 
it picks up from table registration,
here, should it be /api/registration?  rather /api/login ?? 
*/
