...
router.post('/api/attendance', (req, res) => {
  ...
  /* Simple validation for essential fields - this is damn nuisance.
  if (!IDregistration || !loginUserName || !chkInDTS || !chkOutDTS || volHours === undefined || aVolHours === undefined) {
    console.error('serverRouteAttendance.js line 14 Missing required fields:', req.body); // Log missing fields
    return res.status(400).json({ error: 'serverRouteAttendance.js line 15 Missing required fields' });
  }*/
