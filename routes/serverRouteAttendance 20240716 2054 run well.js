...
/* User data not found. Please log in again
  - comment out attendance.js line 31 , release hardcoded for testing. 
   form works well .  field 1 updated. */

const express = require('express');
const router = express.Router();
// const db = require('../db');     //Error: Cannot find module '../db'
// Make sure the db connection is exported properly from db.js or your connection file
