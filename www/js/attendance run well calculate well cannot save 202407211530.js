...
const hardcodedUserName = 'A'; 
    const userData = {
        ...
        aVolHoursPrevious: 3 // Hardcoded accumulated volunteer hours for testing
    };
...
// Display aVolHoursPrevious previous accumulated volunteer hours on page load
 document.getElementById('aVolHoursPrevious').value = userData.aVolHours;
