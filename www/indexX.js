...
Handle updates or deletions of saved data 
as per application's requirements.
*/

//Back End
//this paragraph moved to casereport.js, to be removed later.
...
/*Match to the database field names
Table: casereport
Columns:
IDcasereport int AI PK 
IDlogin int 
reporterName varchar(20) 
reporterContact varchar(20) 
dateTimePicker datetime 
decDist varchar(30) 
campsite varchar(20) 
issueType varchar(20) 
issuetypeoptions varchar(20) 
problem varchar(3) 
severity varchar(10) 
